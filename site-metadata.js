exports.siteMetaData = {
  ...
  productApproach: {
    ...
    subSections: [
      {
        title: 'Customer is the king and quicker iteration is a crowd pleaser!',
        description: [
      ...
      {
        title: 'Build what is necessary, predict what is missing.',
        description: [
      ...
      {
        title: 'Business first, solution later',
        description: [
      ...
      {
        title: 'Choose what we can do justice to!',
        description: [
  ...
  teamApproach: {
    ...
    subSections: [
      ...
      {
        title: 'Engineers vs "React developers"',
        description: [
      ...
      {
        title: 'Hire fresh, and let them discover what they love',
        description: [
      ...
      {
        title: 'Drive engagement through learning',
        description: [
      ...
      {
        title: "It's always better in pairs!",
        description: [
  ...
  expertise: {
    ...
    subSections: [
      ...
      {
        title: 'Modeling complex business processes',
        description: [
